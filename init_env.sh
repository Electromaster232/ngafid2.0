export NGAFID_REPO=$(pwd)
export NGAFID_DATA_FOLDER=$NGAFID_REPO/data
...
export NGAFID_BACKUP_DIR=true
export NGAFID_BACKUP_TABLES="user fleet airframes airframe_types tails user_preferences user_preferences_metrics 
double_series_names stored_filters string_series_names data_type_names flight_tags sim_aircraft uploads"
